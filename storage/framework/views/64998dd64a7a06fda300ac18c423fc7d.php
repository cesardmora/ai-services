<?php $__env->startSection('title', 'NeuralForge — IA para empresas que lideran el futuro'); ?>
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <div class="hero-actions">
            <a href="<?php echo e(route('servicios')); ?>" class="btn btn-primary">Ver servicios →</a>
            <a href="<?php echo e(route('contacto')); ?>" class="btn btn-ghost">Hablar con un experto</a>
        </div>
...
<section class="stats-strip">
    <div class="stats-inner">
        ...
        <div class="stat">
            <div class="stat-val"><?php echo e($stat['valor']); ?></div>
            <div class="stat-label"><?php echo e($stat['etiqueta']); ?></div>
        </div>
...
<section class="services-section">
    ...
    <div class="services-grid">
        <?php $__currentLoopData = $serviciosDestacados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="service-card" data-color="<?php echo e($s['color']); ?>">
            <span class="service-icon"><?php echo e($s['icono']); ?></span>
            <h3><?php echo e($s['titulo']); ?></h3>
            <p><?php echo e($s['descripcion']); ?></p>
            <a href="<?php echo e(route('servicios.show', $s['slug'])); ?>" class="service-link">
                Ver más →
            </a>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div style="text-align:center; margin-top:3rem;">
        <a href="<?php echo e(route('servicios')); ?>" class="btn btn-ghost">Ver todos los servicios →</a>
    </div>
</section>
...
<section class="cta-band">
    ...
    <a href="<?php echo e(route('contacto')); ?>" class="btn btn-primary">Solicitar demo gratuita</a>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/cesar/Sites/ai-services/resources/views/home.blade.php ENDPATH**/ ?>